// Compiled using marko@4.14.12 - DO NOT EDIT
"use strict";

var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/casadocodigo$1.0.0/src/app/views/livros/lista/lsita.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("<h1> Listagem de Livros </h1><table id=\"livros\"><tr><td>ID</td><td>Titulo</td><td>Precos</td><td>Editar</td><td>Remover</td></tr>");
...
marko_template.meta = {
    id: "/casadocodigo$1.0.0/src/app/views/livros/lista/lsita.marko",
    tags: [
